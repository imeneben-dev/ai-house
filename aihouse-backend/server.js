...
// ─────────────────────────────────────────────
// EDIT/UPDATE EVENT ROUTE
// ─────────────────────────────────────────────
app.put('/api/events/:id', verifyToken, async (req, res) => {
  try {
    // 1. Find the event in the database and update it with everything sent in the request body
    ...
    // 2. Send the updated event back to the frontend
